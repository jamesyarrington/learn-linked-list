...
{
    class OpenAddressingHashTableTests
    {
        private OpenAddressingHashTable<string, string> _testHashTable;
        ...
        public void SetUp()
        {
            _testHashTable = new OpenAddressingHashTable<string, string>();
        }
        ...
        {
            _testHashTable = new OpenAddressingHashTable<string, string>(1);
            _testHashTable.Add("garbage in", "garbage out");
            _testHashTable.Add("Guess what will never see the light of day.", "this");
            _testHashTable.Add("Will.Uneccesary?Punctioantion>Break}Things", "better,not");
            _testHashTable.Add(_testKey, _testValue);
